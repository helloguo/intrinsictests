...
void __declspec(noinline) __cdecl run_palignr_xmm1xmm21_10_times()
{
    __asm {
        palignr xmm1, xmm2, 1
        palignr xmm1, xmm2, 1
...
void  test_palignr_xmm1xmm21()
{
    ...
    {
        run_palignr_xmm1xmm21_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_palignr_xmm1xmm21_20_times();
    }
    clock_t t3 = clock();
...
void __declspec(noinline) __cdecl run_phaddd_xmm1xmm2_10_times()
{
    __asm {
        phaddd xmm1, xmm2
        phaddd xmm1, xmm2
...
void  test_phaddd_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_phaddd_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_phaddd_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_phaddw_xmm1xmm2_10_times()
{
    __asm {
        phaddw xmm1, xmm2
        phaddw xmm1, xmm2
...
void  test_phaddw_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_phaddw_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_phaddw_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_phaddsw_xmm1xmm2_10_times()
{
    __asm {
        phaddsw xmm1, xmm2
        phaddsw xmm1, xmm2
...
void  test_phaddsw_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_phaddsw_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_phaddsw_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_phsubd_xmm1xmm2_10_times()
{
    __asm {
        phsubd xmm1, xmm2
        phsubd xmm1, xmm2
...
void  test_phsubd_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_phsubd_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_phsubd_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_phsubw_xmm1xmm2_10_times()
{
    __asm {
        phsubw xmm1, xmm2
        phsubw xmm1, xmm2
...
void  test_phsubw_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_phsubw_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_phsubw_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_phsubsw_xmm1xmm2_10_times()
{
    __asm {
        phsubsw xmm1, xmm2
        phsubsw xmm1, xmm2
...
void  test_phsubsw_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_phsubsw_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_phsubsw_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_pmaddubsw_xmm1xmm2_10_times()
{
    __asm {
        pmaddubsw xmm1, xmm2
        pmaddubsw xmm1, xmm2
...
void  test_pmaddubsw_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_pmaddubsw_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_pmaddubsw_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_pmulhrsw_xmm1xmm2_10_times()
{
    __asm {
        pmulhrsw xmm1, xmm2
        pmulhrsw xmm1, xmm2
...
void  test_pmulhrsw_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_pmulhrsw_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_pmulhrsw_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_pshufb_xmm1xmm2_10_times()
{
    __asm {
        pshufb xmm1, xmm2
        pshufb xmm1, xmm2
...
void  test_pshufb_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_pshufb_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_pshufb_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_psignb_xmm1xmm2_10_times()
{
    __asm {
        psignb xmm1, xmm2
        psignb xmm1, xmm2
...
void  test_psignb_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_psignb_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_psignb_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_psignd_xmm1xmm2_10_times()
{
    __asm {
        psignd xmm1, xmm2
        psignd xmm1, xmm2
...
void  test_psignd_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_psignd_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_psignd_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_psignw_xmm1xmm2_10_times()
{
    __asm {
        psignw xmm1, xmm2
        psignw xmm1, xmm2
...
void  test_psignw_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_psignw_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_psignw_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_pabsb_xmm1xmm2_10_times()
{
    __asm {
        pabsb xmm1, xmm2
        pabsb xmm1, xmm2
...
void  test_pabsb_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_pabsb_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_pabsb_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_pabsd_xmm1xmm2_10_times()
{
    __asm {
        pabsd xmm1, xmm2
        pabsd xmm1, xmm2
...
void  test_pabsd_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_pabsd_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_pabsd_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
...
void __declspec(noinline) __cdecl run_pabsw_xmm1xmm2_10_times()
{
    __asm {
        pabsw xmm1, xmm2
        pabsw xmm1, xmm2
...
void  test_pabsw_xmm1xmm2()
{
    ...
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_pabsw_xmm1xmm2_10_times();
    }
    clock_t t2 = clock();
    for (int iterator = 0; iterator < 1000000; iterator++)
    {
        run_pabsw_xmm1xmm2_20_times();
    }
    clock_t t3 = clock();
    clock_t clk = (t3 - t2) - (t2 - t1);
